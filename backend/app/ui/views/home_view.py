...
def build_home_view(page: ft.Page, update_cart_callback, update_wishlist_callback, open_detail_callback):
    ...
    # Promotion Banner matching image
    banner = ft.Container(
    ...
    for p in all_products[:6]:
        ...
        grid.controls.append(
            ft.Container(
                ...
                on_click=lambda e, item=p: open_detail_callback(item), # Open full screen detail page
                content=ft.Column([
                    ft.Stack([
                        ft.Container(
