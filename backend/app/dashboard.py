    ...
    login_view = ft.Container(
        ...
        content=ft.Column([
            ...
            ft.Container(
                ...
                width=420,
                content=ft.Column([
                    ft.Text("AyuTech Staff Login", size=18, weight=ft.FontWeight.BOLD),
                    identifier_field,
                    pin_field,
                    ft.Row([
                        ft.ElevatedButton("Login", bgcolor="#2563EB", color="white", on_click=handle_pin_login),
                        ft.TextButton("Exit", on_click=lambda e: page.window and page.window.close())
                    ], spacing=12)
                ], spacing=12)
            )
